...
import { IconMap, IconAnchor } from '../components/Icons';
  ...
  return (
    <div className="py-16 md:py-24 container mx-auto px-4 animate-fadeIn">
      <div className="text-center mb-12 max-w-5xl mx-auto">
        <h1 className="text-[var(--fluid-h2)] font-black text-nautical mb-6 leading-tight tracking-tight">
      ...
      {/* Yandex Map Section */}
      <ScrollReveal className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 mb-16 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        <ScrollReveal stagger={1} className="h-full">
          <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-50 flex items-start h-full">
            ...
            <div>
              <h4 className="font-bold text-nautical text-xl mb-3">Со стороны Камышина</h4>
        ...
        <ScrollReveal stagger={2} className="h-full">
          <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-50 flex items-start h-full">
            <div className="bg-green-100 text-green-600 p-4 rounded-2xl mr-6">
              <IconAnchor className="w-8 h-8" />
            </div>
            <div>
              <h4 className="font-bold text-nautical text-xl mb-3">Со стороны Николаевска</h4>
              <p className="text-gray-600 leading-relaxed">
