    ...
    <div className="py-16 md:py-24 container mx-auto px-4 animate-fadeIn">
      <div className="max-w-4xl mx-auto">
        <ScrollReveal className="text-center mb-16">
          <h1 className="text-[var(--fluid-h2)] font-black text-nautical mb-4 leading-tight tracking-tight">Политика конфиденциальности</h1>
          <div className="w-24 h-1.5 bg-blue-500 mx-auto rounded-full"></div>
        </ScrollReveal>

        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-12 prose prose-blue max-w-none text-gray-700">
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-nautical mb-4">1. Общие положения</h2>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Настоящая политика Оператора в отношении обработки персональных данных применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <span className="font-semibold text-blue-600">https://grp34.ru</span>.</li>
            </ul>
          </section>

          <section className="mb-10">
            <h2 className="text-2xl font-bold text-nautical mb-4">2. Реквизиты оператора</h2>
            <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100">
              <p className="font-bold text-nautical mb-2">ООО «Грузовая переправа»</p>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-nautical mb-4">3. Какие данные мы собираем</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-nautical mb-4">4. Цели обработки персональных данных</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-nautical mb-4">5. Срок обработки</h2>
            <p>
              Обработка персональных данных осуществляется на неограниченный срок. Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на адрес <a href="mailto:info@grp34.ru" className="text-blue-600 hover:underline">info@grp34.ru</a>.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-nautical mb-4">6. Заключительные положения</h2>
            <p>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-500 text-sm italic">Последнее обновление: {new Date().toLocaleDateString('ru-RU')}</p>
        </div>
      </div>
    </div>
  );
